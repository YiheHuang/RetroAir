...
根据 README，模型对比实验使用 8 城市 310,756 个样本，采用随机切分方式进行训练与测试评估。选择随机切分而非时间切分，是因为本项目核心任务是历史 \pmfine{} 回顾性推断和空间补全，而不是未来时间序列预测。换言之，系统希望在已有历史气象与 \aod{} 条件下估计某位置的历史 \pmfine{} 浓度，因此随机切分能够评估模型在整体历史分布上的拟合和泛化能力。
